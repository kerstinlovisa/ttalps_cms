...
# treeOutputFilePath = f"{base_path}backgrounds/TTbar_inclusive/skimmed_signalLike/FCA55055-C8F3-C44B-8DCC-6DCBC0B8B992.root"

# signal
inputFilePath = f"{base_path}signals/tta_mAlp-0p35GeV/skimmed_looseSemileptonic/tta_mAlp-0p35GeV_nEvents-100000.root"
treeOutputFilePath = f"{base_path}signals/tta_mAlp-0p35GeV/skimmed_signalLike/tta_mAlp-0p35GeV_nEvents-100000.root"
...
# treeOutputFilePath = f"{base_path}collision_data/SingleMuon2018/skimmed_signalLike/36ED9511-D46A-0C4F-A485-C2DF1C874906.root"
