...
if [ $username == "jniedzie" ]
  ...
  then  
    user_base_path="/afs/desy.de/user/${firstletter}/${username}/TTALP/MC_sample_production/LHEproduction"
    output_path="/nfs/dust/cms/user/${username}/ttalps_cms/signal_LHE_files/MC_info"
