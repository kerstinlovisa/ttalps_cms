...
print('Output MiniAOD file: output/UL_MiniAOD/'+channel_directory+'/'+channel+'_MiniAOD_{0}.root'.format(sys.argv[2]))
...
process.source = cms.Source("PoolSource",
    ...
    fileNames = cms.untracked.vstring('file:'+condordir+'/'+channel+'_RECO_{0}.root'.format(sys.argv[2])),
...
process.MINIAODSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:output/UL_MiniAOD/'+channel_directory+'/'+channel+'_MiniAOD_{0}.root'.format(sys.argv[2])),
